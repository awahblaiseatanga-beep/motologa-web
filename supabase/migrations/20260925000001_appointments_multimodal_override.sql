...
DECLARE
    ...
    v_final_voice_note_url TEXT;
BEGIN
    SELECT parent_job_id, status, COALESCE(p_voice_note_url, worker_voice_note_url) INTO v_parent_job_id, v_finding_status, v_final_voice_note_url
    ...
    INSERT INTO public.appointments (
        ...
        p_scheduled_date, p_scheduled_time, p_issue_description, v_final_voice_note_url,
